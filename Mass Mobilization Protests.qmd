...
pt_rec <- recipe(lethal ~ ., data = pt_train) %>%
  ...
  # Convert [Participants] and [Happiness Score] to ordinal factor.
...
What can we learn from the model? What are the most important features to predict lethality according to the random forest model?
